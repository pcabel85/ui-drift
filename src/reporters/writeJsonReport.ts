...
<div class="page">
  <header>
    <div>
      ...
      <div class="meta" style="margin-top:0.4rem">Discovery Mode: <span style="color:${isDriftSense ? '#f59e0b' : '#94a3b8'};font-weight:600">${isDriftSense ? 'DriftSense' : 'Standard'}</span></div>
    </div>
  </header>
  ...
  <footer>Generated by ui-drift v0.2</footer>
</div>
</body>
</html>`;
